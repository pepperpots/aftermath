...
static struct am_timeline_render_layer_type* (*inst_functions[])(void) = {
	...
	am_timeline_openmp_thread_layer_instantiate_type,
	am_timeline_openmp_parallel_layer_instantiate_type,
	am_timeline_openmp_task_create_layer_instantiate_type,
	am_timeline_openmp_task_schedule_layer_instantiate_type,
	am_timeline_openmp_implicit_task_layer_instantiate_type,
	am_timeline_openmp_sync_region_wait_layer_instantiate_type,
	am_timeline_openmp_mutex_released_layer_instantiate_type,
	am_timeline_openmp_dependences_layer_instantiate_type,
	am_timeline_openmp_task_dependence_layer_instantiate_type,
	am_timeline_openmp_work_layer_instantiate_type,
	am_timeline_openmp_master_layer_instantiate_type,
	am_timeline_openmp_sync_region_layer_instantiate_type,
	am_timeline_openmp_lock_init_layer_instantiate_type,
	am_timeline_openmp_lock_destroy_layer_instantiate_type,
	am_timeline_openmp_mutex_acquire_layer_instantiate_type,
	am_timeline_openmp_mutex_acquired_layer_instantiate_type,
	am_timeline_openmp_nest_lock_layer_instantiate_type,
	am_timeline_openmp_flush_layer_instantiate_type,
	am_timeline_openmp_cancel_layer_instantiate_type,
